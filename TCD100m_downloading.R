...
#unzipping the files
outDir<-"C:/Users/am1355/OneDrive - University of Leicester/Publications/EURAF_LPIS/TCD100m_raw/"
#getting files
files <- list.files("//uol.le.ac.uk/root/staff/home/a/am1355/Downloads/",
                    pattern = "R00.zip")
...
files <- list.files("C:/Users/am1355/OneDrive - University of Leicester/Publications/EURAF_LPIS/TCD100m_raw/",
                    full.names = TRUE)

vrt(files, filename = "C:/Users/am1355/OneDrive - University of Leicester/Publications/EURAF_LPIS/TCD100m")
